...
# --- CONFIG ------------------------------------------------------------------
GPU_ID=0
RUN_NAME=peg_hole_vision_v1

# data + horizon
TASK=real_peg_insertion_vis                     # name of config/task/<TASK>.yaml
HORIZON=16
N_OBS_STEPS=2
...
# encoder
# resize_shape now comes from task yaml (image_resize_shape). Override via CLI
# only if you need to deviate from the task default.
